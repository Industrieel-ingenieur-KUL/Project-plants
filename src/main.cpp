...
//-------------------------------------------------------------
// I2C Pin Definitions (ESP32 Defaults for Wire library)
// These pins should be connected to the ENS160 sensor.
//-------------------------------------------------------------
...
// Using address 0x53 (ENS160_I2CADDR_1)
...
void setup()
{
  ...
  i2cScan(I2C_SDA_PIN, I2C_SCL_PIN);
